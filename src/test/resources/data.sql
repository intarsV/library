...
insert into books ( book_id, book_title, book_author, book_genre, copies, available, enabled) values (1, 'Zelta zirgs', 1, 'POETRY', 7, 6, true);
insert into books ( book_id, book_title, book_author, book_genre, copies, available, enabled) values (2, 'Super book', 3, 'NOVEL', 5, 4, true);
insert into books ( book_id, book_title, book_author, book_genre, copies, available, enabled) values (3, 'Nāves enā', 2, 'PROSE', 9, 9, true );
